...
const PAYFAST_CONFIG = {
  ...
  notifyUrl: process.env.PAYFAST_NOTIFY_URL || 'https://api.elitetcg.co.za/api/payfast/notify'
};
...
function generateStorePaymentData(order, buyer) {
  ...
  const storeNotifyUrl = process.env.PAYFAST_STORE_NOTIFY_URL || 'https://api.elitetcg.co.za/api/orders/notify';
